...
<html>
    <head>
        <title>Adventure Gaming a Games a Category Flat Bootstarp Responsive Website Template | Contact ::
               w3layouts</title>
                ...
                <div class="headr-right">
                    <div class="details">
                        <ul>
                            ...
                            <li><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span>(+1)000 123 456789
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="container">
                ...
                <div class="top-menu">
                    ...
                    <ul class="nav1">
                        ...
                        <li class="active"><a href="contact.php">Mail</a></li>
                    </ul>
                </div>
                <!-- script-for-menu -->
                <script>
